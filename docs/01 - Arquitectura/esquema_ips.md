...
**Servidor DHCP:** R-02 (192.168.20.1)  
**DNS proporcionado por DHCP:** 192.168.20.1  
...
| Red        | Hostname / Equipo      | IP               | Máscara        | Gateway      | Tipo IP   | Servicios / Observaciones                   |
|------------|-------------------------|------------------|----------------|--------------|-----------|--------------------------------------------|
| DMZ        | R-N02 (Router/DNS/DHCP) | 192.168.20.1     | 255.255.255.0 | –            | Fija      | Gateway DMZ                                 |
|            | S1-N02 (Web Server)     | 192.168.20.2     | 255.255.255.0 | 192.168.20.1 | Fija      | Web, FTP, SSH                               |
| Intranet   | R-N02 (Router)          | 192.168.120.1    | 255.255.255.0 | –            | Fija      | Gateway, DHCP, DNS, Intranet                |
|            | S2-N02 (DB)             | 192.168.20.5     | 255.255.255.0 | 192.168.20.1 | Fija      | MySQL, Monitor                              |
|            | PC-Windows              | DHCP             | 255.255.255.0 | 192.168.120.1| Dinámica  | Rango 192.168.120.100-200                   |
|            | PC-Linux                | DHCP             | 255.255.255.0 | 192.168.120.1| Dinámica  | Rango 192.168.120.100-200                   |
