...
| **name** | Texto (String) | Nombre oficial del equipamiento educativo. |
| **institution_id** | Identificador (Texto/Entero) | ID de la institución a la que pertenece (a menudo vacío). |
...
| **addresses_roadtype_id** | Identificador (Texto/Entero) | ID del tipo de vía. |
| **addresses_roadtype_name** | Texto (String) | Nombre del tipo de vía (p. ej., "Carrer", "Avinguda"). |
| **addresses_road_id** | Identificador (Entero) | ID de la vía. |
| **addresses_road_name** | Texto (String) | Nombre de la vía. |
| **addresses_start_street_number** | Texto/Numérico (String) | Número inicial del edificio. |
| **addresses_end_street_number** | Texto/Numérico (String) | Número final del rango de la dirección (si aplica, puede estar vacío). |
...
| **addresses_zip_code** | Código Postal (Entero) | Código postal. |
...
| **values_attribute_id** | Identificador (Entero) | ID de un atributo de valor. |
...
| **values_description** | Texto (String) | Descripción adicional del valor (mayormente vacío). |
...
| **geo_epgs_4326_lat** | Decimal (Float) | Latitud en el sistema de referencia EPSG:4326 (WGS 84). |
| **geo_epgs_4326_lon** | Decimal (Float) | Longitud en el sistema de referencia EPSG:4326 (WGS 84). |
